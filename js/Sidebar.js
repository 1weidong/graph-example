...
Sidebar.prototype.addUmlPalette = function(expand)
{
	...
	var field = new mxCell(transformXml(fieldParams), new mxGeometry(0, 0, 100, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;
	...
	var fns = [
		this.addEntry(dt + 'section subsection', function()
		{
			...
			var cell = new mxCell(transformXml(moduleParams, 'module'), new mxGeometry(0, 0, 140, 20),
			...
			cell.vertex = true;
			return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Module');
		}),
		this.addEntry(dt + 'section subsection', function()
		{
			var sequenceParams = [
			...
			var cell = new mxCell(transformXml(sequenceParams, 'sequence'), new mxGeometry(0, 0, 140, 20),
				'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
			cell.vertex = true;
			return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Sequence');
		}),
		this.addEntry(dt + 'section subsection', function()
		{
			var enumParams = [
			...
			var cell = new mxCell(transformXml(enumParams, 'enumType'), new mxGeometry(0, 0, 140, 110),
				'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
			cell.vertex = true;
			return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Enum');
		}),
		this.addEntry(dt + 'section subsection', function()
		{
			var entityParams = [
			...
			var cell = new mxCell(transformXml(entityParams, 'entity'), new mxGeometry(0, 0, 140, 110),
				'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
			cell.vertex = true;
		...
		// this.addEntry(dt + 'section subsection', function()
		// {
		// 	var cell = new mxCell('enum', new mxGeometry(0, 0, 140, 110),
		// 		'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
		// 	cell.vertex = true;
	...
	function transformXml(options, name) {
		...
		if (options.length > 0) {
			...
			obj.setAttribute('label', 'defaulde');
		}
		return obj;
	}
...
Sidebar.prototype.createItem = function(cells, title, showLabel, showTitle, width, height, allowCellsInserted)
{
	...
	// for (var i=0; i<cells[0].children.length; i++) {
	// 	graph.getModel().setValue(cells[0].children[i], '<object label="+filed：" type="string"></object>')
	// }
	return elt;
};
